...
let edadSofia = person.age;
let edadSofiaBracket = person["age"];

console.log(`DOT NOTATION: ${edadSofia}`);
console.log(`BRACKET NOTATION: ${edadSofiaBracket}`);
...
let frase = '"The book", book.title, "was written by", book.author, "and is", book.pages, "pages."';
...
console.log(`${user["personalInfo"]["name"]} lives at ${user["personalInfo"]["address"]["line1"]} ${user["personalInfo"]["address"]["line2"]},
 ${user["personalInfo"]["address"]["city"]}, ${user["personalInfo"]["address"]["country"]}.`);
...
console.log(`The data type of ${animal.edad} is a ${typeof animal.edad}`);
